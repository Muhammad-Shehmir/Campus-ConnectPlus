...
const AIRecommendations = ({ navigation, isSidebar = false }) => {
  ...
  // Debug logging
  console.log('AIRecommendations - isMobile:', isMobile, 'isSidebar:', isSidebar, 'horizontal:', !isSidebar || isMobile);
    ...
    <Card3D variant="elevated" style={[styles.container, isSidebar && styles.sidebarContainer]}>
      ...
      <FlatList 
        ...
        contentContainerStyle={[
          ...
          (isSidebar && !isMobile) ? styles.verticalScrollContent : styles.horizontalScrollContent
        ]}
        scrollEnabled={true}
